...
# Ordem sugerida de publicação (3x/semana ≈ 11 semanas)

> Alterna 3 objetivos: **inspirar** (história/frase), **ensinar** (método/dica), **converter** (livro/testes). 1x por semana puxa para os testes ou o livro.

| Sem | Seg (inspirar) | Qua (ensinar) | Sex (converter) |
|---|---|---|---|
| 1 | Zona de conforto | 3Cs | 2ª Edição (livro) |
| 2 | Bertioga-Maresias | Basico 1 - assessoria | Autossabotagem → testes |
| 3 | Liberdade da corrida | Basico 2 - pace | Metodo (check-list) |
| 4 | Aumentar Resiliência | Evolução Pace | O mais importante 1º → testes |
| 5 | Maratona solo | Redução Peso | conhecimentoemacao |
| 6 | Proposito | O poder das pequenas coisas | Mude de Patamar - Profissional → testes |
